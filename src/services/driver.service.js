...
async function createDriverOrderDetail (DriverIDs, OrderIDs){
    ...
    const updateOrderSql = "UPDATE shipping_orders SET driver_name = ?, driver_license_plate = ?, driver_phone_number = ?, shipping_status = 'Tài xế đang đi!', order_dispatch_date = NOW() WHERE OrderID = ?";
    try {
